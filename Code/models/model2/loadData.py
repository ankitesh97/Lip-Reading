...
def loadDataQueue(COLORFLAG=0,data='train'):
    SOURCE_DIRECTORY = '../../../Data/model2/9wordsX500videosEndBlackLabel/modified/'
    COLOR_SOURCE_DIRECTORY = '../../../Data/model2/9wordsX500videosEndBlackLabel/modified-color/'
    DIRECTORY=''
    if COLORFLAG==0:
...
def getFeatureVector(filename,seq_len,word,is_train):
    BASE_ADD = '../../../Data/model2/lip-border3/'
